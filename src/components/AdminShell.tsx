...
export default function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen" style={{
      ...
      "--primary": "#a04552", "--primary-dark": "#7d3541",
      "--accent": "#f0f0f5", "--muted": "#f7f7fa",
          ...
          {nav.map((n) => {
            ...
            return (
              <Link key={n.href} href={n.href}
                className={`flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition-colors ${active ? "bg-[#6c5ce7] text-white" : "text-white/70 hover:bg-white/10 hover:text-white"}`}>
